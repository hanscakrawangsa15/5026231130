...
<body>
    <div id="container">
        <header>
            <h1 style="color: aliceblue;">Bantu Adaptasi Mahasiswa Baru, ITS Gelar Mentoring Agama Islam</h1>
        </header>
    </div>
    <a href="https://www.its.ac.id/news/videos_category/its-tv/">ITS TV</a>
    <a href="https://www.kompas.tv/">Kompas TV</a>
    <a href="https://www.google.co.id/?hl=id">Google</a>
    <a href="pertama.html">Kembali </a>
    <main>
        <article>
            <p>Oleh : itsash <i>I</i> 18 <i>I</i> Source / ITS Online</p>
            <img src="1.jpg" alt="">
            <h2>Suasana Kuliah Umum Mentoring Agama Islam Semester Genap 2024/2025</h2>
            <p>Kampus ITS, ITS News — Institut Teknologi Sepuluh Nopember (ITS) kembali menggelar Mentoring Agama Islam
                ...
                berlangsung di Masjid Manarul Ilmi ITS, Sabtu (22/02).</p>
            <p>Dalam pembukaan acara, Ketua Tim Pembina Kerohanian Islam (TPKI) ITS Prof Dr Muhammad Mashuri MT
            ...
            <p><strong>
                    <address>
                        ...
                        segudang ilmu, termasuk keilmuan Islam,” ujarnya. </address>
                </strong>
            </p>

            <p>Lebih lanjut, dosen yang akrab disapa Mashuri ini menjelaskan, kegiatan mentoring ini terdiri dari
